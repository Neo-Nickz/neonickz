{
	...
	"patches": {
		...
		"Th15SakuyaB": "(TH15) Ports SakuyaB's shottype from DDC to LoLK over Reisen. Bomb and dialogue is unchanged as of now.",
		...
		"AverageDanmakufuFinal": "(TH14, 14.3, 15, 16, 17, 18) *1280x960 RESOLUTION ONLY* Expands the playable field to fill the entire screen. This patch also adjusts the stages and bosses to use the extended space. Massive credit to Khangaroo for making the original binhacks for this!",
        "YouGrowBigger": "(TH14, 15, 16, 17, 18) You're big now. That's the patch. Applies the You Grow Bigger gimmick for the entire run! This also affects their hitbox, and shottype. Clearing Hard+ with this is probably impossible lmao"
	},
	"servers": [
