...
entry {
    ...
    sprites: {
        ...
        sprite35: {x: 64.0, y: 192.0, w: 32.0, h: 32.0},
        sprite36: {x: 96.0, y: 192.0, w: 32.0, h: 32.0},
        sprite37: {x: 128.0, y: 192.0, w: 32.0, h: 32.0},
        sprite38: {x: 160.0, y: 192.0, w: 32.0, h: 32.0},
        sprite39: {x: 192.0, y: 192.0, w: 32.0, h: 32.0},
        sprite40: {x: 224.0, y: 192.0, w: 32.0, h: 32.0},
        sprite41: {x: 64.0, y: 224.0, w: 32.0, h: 32.0},
        sprite42: {x: 96.0, y: 224.0, w: 32.0, h: 32.0},
        sprite43: {x: 128.0, y: 224.0, w: 32.0, h: 32.0},
        sprite44: {x: 160.0, y: 224.0, w: 32.0, h: 32.0},
        sprite45: {x: 192.0, y: 224.0, w: 32.0, h: 32.0},
        sprite46: {x: 224.0, y: 224.0, w: 32.0, h: 32.0},
        sprite47: {x: 0.0, y: 192.0, w: 32.0, h: 32.0},
        sprite48: {x: 32.0, y: 192.0, w: 32.0, h: 32.0},
        sprite49: {x: 64.0, y: 192.0, w: 48.0, h: 32.0},
        sprite50: {x: 112.0, y: 192.0, w: 48.0, h: 32.0},
        sprite51: {x: 64.0, y: 144.0, w: 16.0, h: 16.0},
        sprite52: {x: 80.0, y: 144.0, w: 16.0, h: 16.0},
        sprite53: {x: 96.0, y: 144.0, w: 16.0, h: 16.0},
        sprite54: {x: 1.0, y: 193.0, w: 62.0, h: 62.0},
    },
}
...
entry {
    ...
    memory_priority: 0,
    sprites: {
        sprite55: {x: 0.0, y: 0.0, w: 64.0, h: 64.0},
        sprite56: {x: 0.0, y: 64.0, w: 192.0, h: 192.0},
    },
}
...
entry {
    ...
    img_height: 128,
    memory_priority: 0,
    sprites: {sprite57: {x: 0.0, y: 0.0, w: 128.0, h: 128.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite58: {x: 0.0, y: 0.0, w: 190.0, h: 205.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite59: {x: 0.0, y: 0.0, w: 190.0, h: 205.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite60: {x: 0.0, y: 0.0, w: 190.0, h: 205.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite61: {x: 0.0, y: 0.0, w: 190.0, h: 205.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite62: {x: 0.0, y: 0.0, w: 190.0, h: 205.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite63: {x: 0.0, y: 0.0, w: 190.0, h: 205.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite64: {x: 0.0, y: 0.0, w: 190.0, h: 205.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite65: {x: 0.0, y: 0.0, w: 190.0, h: 205.0}},
}
...
entry {
    ...
    low_res_scale: true,
    sprites: {
        sprite67: {x: 0.0, y: 0.0, w: 575.0, h: 660.0},
        sprite68: {x: 0.0, y: 0.0, w: 0.0, h: 0.0},
    },
}
...
interrupt[2]:
    layer(27);
    resolutionMode(2);
    posTime(15, 5, 104.0, 300.0, 0.0);
    rgbTime(15, 0, 255, 255, 255);
+15: // 30
    stop();

interrupt[7]:
    posTime(2, 0, 96.0, 292.0, 0.0);
+2: // 32
    posTime(2, 0, 100.0, 304.0, 0.0);
+2: // 34
    posTime(2, 0, 112.0, 296.0, 0.0);
+2: // 36
    posTime(2, 0, 108.0, 308.0, 0.0);
+2: // 38
    posTime(2, 0, 104.0, 292.0, 0.0);
+2: // 40
    posTime(2, 0, 96.0, 304.0, 0.0);
+2: // 42
    posTime(2, 0, 100.0, 296.0, 0.0);
+2: // 44
    posTime(2, 0, 112.0, 308.0, 0.0);
+2: // 46
    posTime(2, 0, 100.0, 296.0, 0.0);
+2: // 48
    posTime(2, 0, 104.0, 304.0, 0.0);
+15: // 63
    stop();
