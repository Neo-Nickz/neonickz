...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite49: {x: 0.0, y: 0.0, w: 216.0, h: 190.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite50: {x: 0.0, y: 0.0, w: 216.0, h: 190.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite51: {x: 0.0, y: 0.0, w: 216.0, h: 190.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite52: {x: 0.0, y: 0.0, w: 216.0, h: 190.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite53: {x: 0.0, y: 0.0, w: 216.0, h: 190.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite54: {x: 0.0, y: 0.0, w: 216.0, h: 190.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite55: {x: 0.0, y: 0.0, w: 216.0, h: 190.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite56: {x: 0.0, y: 0.0, w: 216.0, h: 190.0}},
}
...
entry {
    ...
    low_res_scale: true,
    sprites: {
        sprite58: {x: 0.0, y: 0.0, w: 688.0, h: 700.0},
        sprite59: {x: 0.0, y: 0.0, w: 0.0, h: 0.0},
    },
}
...
interrupt[2]:
    layer(31);
    resolutionMode(2);
    posTime(15, 5, 220.0, 260.0, 0.0);
    rgbTime(15, 0, 255, 255, 255);
+15: // 30
    stop();

interrupt[7]:
    posTime(2, 0, 212.0, 252.0, 0.0);
+2: // 32
    posTime(2, 0, 216.0, 264.0, 0.0);
+2: // 34
    posTime(2, 0, 228.0, 256.0, 0.0);
+2: // 36
    posTime(2, 0, 224.0, 268.0, 0.0);
+2: // 38
    posTime(2, 0, 220.0, 252.0, 0.0);
+2: // 40
    posTime(2, 0, 212.0, 264.0, 0.0);
+2: // 42
    posTime(2, 0, 216.0, 256.0, 0.0);
+2: // 44
    posTime(2, 0, 228.0, 268.0, 0.0);
+2: // 46
    posTime(2, 0, 216.0, 256.0, 0.0);
+2: // 48
    posTime(2, 0, 220.0, 264.0, 0.0);
+15: // 63
    stop();
