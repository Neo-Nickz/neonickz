...
entry {
    ...
    sprites: {
        ...
        sprite28: {x: 0.0, y: 177.0, w: 512.0 / 2.0, h: 14.0},
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite52: {x: 0.0, y: 0.0, w: 280.0, h: 244.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite53: {x: 0.0, y: 0.0, w: 280.0, h: 244.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite54: {x: 0.0, y: 0.0, w: 280.0, h: 244.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite55: {x: 0.0, y: 0.0, w: 280.0, h: 244.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite56: {x: 0.0, y: 0.0, w: 280.0, h: 244.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite57: {x: 0.0, y: 0.0, w: 280.0, h: 244.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite58: {x: 0.0, y: 0.0, w: 280.0, h: 244.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite59: {x: 0.0, y: 0.0, w: 280.0, h: 244.0}},
}
...
entry {
    ...
    low_res_scale: true,
    sprites: {
        sprite61: {x: 0.0, y: 0.0, w: 580.0, h: 660.0},
...
interrupt[2]:
    layer(26);
    resolutionMode(2);
    posTime(15, 5, 116.0, 340.0, 0.0);
    rgbTime(15, 0, 255, 255, 255);
+15: // 30
    stop();

interrupt[7]:
    posTime(2, 0, 108.0, 332.0, 0.0);
+2: // 32
    posTime(2, 0, 112.0, 344.0, 0.0);
+2: // 34
    posTime(2, 0, 124.0, 336.0, 0.0);
+2: // 36
    posTime(2, 0, 120.0, 348.0, 0.0);
+2: // 38
    posTime(2, 0, 116.0, 332.0, 0.0);
+2: // 40
    posTime(2, 0, 108.0, 344.0, 0.0);
+2: // 42
    posTime(2, 0, 112.0, 336.0, 0.0);
+2: // 44
    posTime(2, 0, 124.0, 348.0, 0.0);
+2: // 46
    posTime(2, 0, 112.0, 336.0, 0.0);
+2: // 48
    posTime(2, 0, 116.0, 344.0, 0.0);
+15: // 63
    stop();
