...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite46: {x: 0.0, y: 0.0, w: 330.0, h: 200.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite47: {x: 0.0, y: 0.0, w: 330.0, h: 200.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite48: {x: 0.0, y: 0.0, w: 330.0, h: 200.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite49: {x: 0.0, y: 0.0, w: 330.0, h: 200.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite50: {x: 0.0, y: 0.0, w: 330.0, h: 200.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite51: {x: 0.0, y: 0.0, w: 330.0, h: 200.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite52: {x: 0.0, y: 0.0, w: 330.0, h: 200.0}},
}
...
entry {
    ...
    memory_priority: 0,
    low_res_scale: true,
    sprites: {sprite53: {x: 0.0, y: 0.0, w: 330.0, h: 200.0}},
}
...
entry {
    path: "face/pl00/face_pl00bs2.png",
    img_width: 484,
    img_height: 660,
    memory_priority: 0,
    low_res_scale: true,
    sprites: {
        sprite55: {x: 0.0, y: 0.0, w: 484.0, h: 660.0},
...
interrupt[2]:
    layer(26);
    resolutionMode(2);
    posTime(15, 5, 118.0, 300.0, 0.0);
    rgbTime(15, 0, 255, 255, 255);
+15: // 30
    stop();

interrupt[7]:
    posTime(2, 0, 110.0, 292.0, 0.0);
+2: // 32
    posTime(2, 0, 114.0, 304.0, 0.0);
+2: // 34
    posTime(2, 0, 126.0, 296.0, 0.0);
+2: // 36
    posTime(2, 0, 122.0, 308.0, 0.0);
+2: // 38
    posTime(2, 0, 118.0, 292.0, 0.0);
+2: // 40
    posTime(2, 0, 110.0, 304.0, 0.0);
+2: // 42
    posTime(2, 0, 114.0, 296.0, 0.0);
+2: // 44
    posTime(2, 0, 126.0, 308.0, 0.0);
+2: // 46
    posTime(2, 0, 114.0, 296.0, 0.0);
+2: // 48
    posTime(2, 0, 118.0, 304.0, 0.0);
+15: // 63
    stop();
...
-1:
    ...
    pos(-80.0, 0.0, 0.0);
0:
    scriptNewFront(script26);
    scriptNewFront(script25);
    stop();
